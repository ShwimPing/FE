  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mapContainer}>
        <NaverMapView
          ref={mapViewRef} // ref를 NaverMapView에 연결
          style={styles.map}
          center={{
