...
const Footer = () => {
  ...
  const handleMenuPress = (menu: keyof RootStackParamList) => {
    if (menu !== selectedMenu) {
      setSelectedMenu(menu);
      if (menu === 'ContentDetail') {
        navigation.navigate('ContentDetail', {title: 'Sample Title'});
      } else {
    ...
    <View style={styles.container}>
      <TouchableOpacity
        ...
        <Svg
          ...
          viewBox="0 0 25 24"
          fill="none"
          stroke={selectedMenu === 'Home' ? '#1A1A1B' : '#8E9398'}>
          <Path
      ...
      <TouchableOpacity
        style={styles.menuBox}
        onPress={() => handleMenuPress('ContentsList')}>
        <Svg
          width="25"
          height="24"
          viewBox="0 0 25 24"
          fill="none"
          stroke={selectedMenu === 'ContentsList' ? '#1A1A1B' : '#8E9398'}>
          <Path
        ...
        <Text
          style={[
            styles.menuText,
            selectedMenu === 'ContentsList' && styles.selectedText,
          ]}>
          콘텐츠
        </Text>
      </TouchableOpacity>
      <TouchableOpacity
        ...
        <Svg
          ...
          viewBox="0 0 25 24"
          fill="none"
          stroke={selectedMenu === 'MyPage' ? '#1A1A1B' : '#8E9398'}>
          <Path
        ...
        <Text
          style={[
            styles.menuText,
            selectedMenu === 'MyPage' && styles.selectedText,
          ]}>
          마이페이지
        </Text>
      </TouchableOpacity>
